...
const Hero = () => {
  return (
    <div className="relative h-full bg-orange-200" id="#hero">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center mx-4 lg:mx-[8rem] text-center text-orange-50">
        ...
        <div className="mt-6 -mb-24 duration-300 ease-in-out delay-100 cursor-pointer animate-bounce size-8 rounded-3xl hover:bg-stone-800 bg-orange-50 group">
